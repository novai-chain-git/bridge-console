...
const formRules = reactive({
  txHash: [{ required: true, message: '交易Hash不能为空', trigger: 'change' }]
})
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    await TransactionApi.confirmTransfer({ id: formData.value.id, txHash: formData.value.txHash })
