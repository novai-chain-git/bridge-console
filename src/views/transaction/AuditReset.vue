  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="审核时间" prop="auditTime">
        {{ formatTime(formData.auditTime) }}
      </el-form-item>
    </el-form>
    <template #footer>
      <el-button @click="submitForm" type="primary" :disabled="formLoading">重新审核</el-button>
...
const submitForm = async () => {
  ...
  formLoading.value = true
  try {
    await TransactionApi.auditReset(formData.value.id)
