    ...
    <div class="relative mx-auto h-full flex">
      ...
      >
        ...
        <div class="relative flex items-center text-white">
          <span class="text-20px font-bold color-[--left-menu-initializa-font-light-color]"></span>
        </div>
        <!-- 左边的背景图 + 欢迎语 -->
        <div class="h-[calc(100%-60px)] flex items-center justify-center">
          ...
          >
            ...
            <div key="2" class="text-3xl text-white mt-20">{{
      ...
      <div class="relative flex-1 p-30px dark:bg-[var(--login-bg-color)] lt-sm:p-10px">
        ...
        >
          <div class="flex items-center at-2xl:hidden at-xl:hidden">
            <img alt="" class="mr-10px h-48px" src="../../assets/imgs/logo.png" />
            <span class="text-20px font-bold color-[--left-menu-initializa-font-light-color]">{{
              underlineToHump(appStore.getTitle)
            }}</span>
          </div>
          <div class="flex items-center justify-end space-x-10px">
            <ThemeSwitch />
            <LocaleDropdown class="dark:text-white lt-xl:text-[#606266]" />
          </div>
        </div>
        <!-- 右边的登录界面 -->
